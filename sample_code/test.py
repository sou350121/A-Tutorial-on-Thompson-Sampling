...
print('the action token by Greedy is {}'.format(ads_count))
# print the action probabilty 
def plotting_action_prob():
    x_axis = np.array()
ads_count_list = np.mat(ads_count_list)
...
print('the action token by TS is {}'.format(ads_count))
